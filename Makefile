...
postsubmit-update: prow-services origin-release libpod prow-monitoring build-dashboards-validation-image toolchain-image-mirror-setup cincinnati
...
projects: ci-ns gcsweb origin-stable origin-release toolchain-image-mirror-setup image-pruner-setup publishing-bot content-mirror azure python-validation metering
.PHONY: projects
