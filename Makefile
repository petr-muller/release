...
postsubmit-update: prow-services origin-release libpod prow-monitoring build-dashboards-validation-image tekton-image-mirror-setup toolchain-image-mirror-setup cincinnati
...
projects: ci-ns gcsweb origin-stable origin-release tekton-image-mirror-setup toolchain-image-mirror-setup image-pruner-setup publishing-bot content-mirror azure python-validation metering
.PHONY: projects
